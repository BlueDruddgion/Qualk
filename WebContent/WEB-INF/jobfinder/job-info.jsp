          ...
          <div class='row job-row'>
              <div class='col-md-4 box-info'>
                <div class='card card-info'>
                    <img class="card-img-top" src="https://cdn.itviec.com/employers/nextop-co-ltd/logo/w170/kKyKWApkns1bEBfH1wipimdL/nextop-co-ltd-logo.jpg">
                    <div class='card-body'>
                        ...
                        <table class='intro-info'>
                            ...
                            <tr class='category'>
                                ...
                                <td class='value'>51/100</td>
                            </tr>
                            <tr class='category'>
                                <td class='icon'><img class='icon-img' src='images/japan-flag-icon-16.png'></td>
                                <td class='value'>Japan</td>
                            </tr>
                            <tr class='category'>
                                <td class='icon'><i class="fa fa-calendar" aria-hidden="true"></i></td>
                                <td class='value'>Monday - Friday</td>
                            </tr>
                            <tr class='category'>
              ...
              <div class='col-md-8 detail-info'>
                  <div class='intro-container'>
                      ...
                      <div class='more-info'>
                        ...
                        <p class='more-info-item' style='color:#28a745'>You will love it</p>
                      </div>
                      <div class='more-info'>
                  ...
                  <div class='job-detail-info'>
                    <h2 class='title'>Top 3 Reasons To Join Us</h2>
                ...
                <div class='separator'></div>
                  ...
                  <div class='job-detail-info'>
                      ...
                      <ul>
                        <li>Chăm chỉ, có trách nhiệm trong công việc, kỹ năng giao tiếp tốt</li>
                        <li>Có khả năng làm việc độc lập hoặc theo nhóm, chịu được áp lực công việc</li>
                        <li>Sẵn sàng làm thêm ngoài giờ</li>
                      </ul>
                  </div>
                  <div class='separator'></div>
                  <div class='job-detail-info'>
                      ...
                      <p class='list-intro'></p>
                      <ul>
                        <li>Mức lương: cạnh tranh phụ thuộc vào kỹ năng và kinh nghiệm</li>
                        <li>Thời gian làm việc: theo ca, chia 3 ca/ ngày, 24/5 (07:00 – 14:00, 14:00 – 22:00, and 22:00 – 07:00)</li>
                        <li>Chính sách lương làm thêm ngoài giờ hấp dẫn</li>
                        <li>Thưởng: 2 lần/ năm (tương đương 2 tháng lương)</li>
                        <li>Đóng BHXH, BHYT, BHTN theo quy định của luật lao động</li>
