    ...
    <section class='cv'>
        ...
        <div class='container section-container'>
            <div class='row cv-row'>
                ...
                <div class='col-md-4 trust-reach'>
                	<div class='info-part'>
                    	<h2 class='info-key'>Experiences</h2>
                    	<p class='info-value'>${ teacher.experiences }</p>
                    </div>
                    <div class='info-part'>
                        <h2 class='info-key'>Skills</h2>
                        <p class='info-value'>${ teacher.skill }</p>
                    </div>
                    <div class='info-part'>
                        <h2 class='info-key'>Salary Want</h2>
        ...
        <div class='container section-container'>
            <div class='row cv-row'>
                ...
                <div class='col-md-9 info'>
                    ...
                    <p class='info-value'>
                        <a href='javascript:alert("Cannot upload your CV")'><button class='upload-btn'>Upload your CV info</button></a>
                    </p>
