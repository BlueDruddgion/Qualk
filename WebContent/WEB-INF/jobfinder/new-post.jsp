  ...
  <div class="site-wrap">
    ...
    <div class="unit-5 overlay" style="background-image: url('images/hero_1.jpg');">
      <div class="container text-center">
        ...
        <p class="mb-0 unit-6"><a href="${ pageContext.request.contextPath }/home">Home</a> <span class="sep">></span> <span>Post a Job</span></p>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-12 col-lg-8 mb-5">
            ...
            <form action="${ pageContext.request.contextPath }/new-post" class="p-5 bg-white">
          ...
          <div class="col-lg-4">
            ...
            <div class="p-4 mb-3 bg-white">
              ...
              <p><a href="javascript:void(0)" class="btn btn-primary  py-2 px-4">Learn More</a></p>
            </div>
          </div>
        </div>
      </div>
