...
<html class="no-js" lang="en">
    <head>
        ...
        <title> LAHK 1.0 || Admin Home </title>
                            ...
                            <div class="col col-12 col-sm-12 col-md-6 col-xl-7 history-col">
                                ...
                                <div class="card">
                                        ...
                                        <div class="card-title-block">
                                            <h3 class="title"> Lượng truy cập theo ngày</h3>
                                        </div>
                                ...
                                <div class="card sameheight-item items" data-exclude="xs,sm,lg" style="height: 400px;">
                                    <div class="card-header bordered">
                                        <div class="header-block">
                                            ...
                                            <a href="item-editor.html" class="btn btn-primary btn-sm rounded-s"> Thêm mới </a>

                                        </div>
                                        <div class="action dropdown">
                                            <button class="btn  btn-sm rounded-s btn-secondary dropdown-toggle" type="button" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Điều chỉnh... </button>
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenu1">
                                                <a class="dropdown-item" href="#"><i class="fa fa-pencil-square-o icon"></i>Sửa</a>
                                        ...
                                        <label class="item-check" id="select-all-items">
                                            ...
                                            <span></span>
                                                ...
                                                <div class="item-col item-col-title no-overflow">
                                                    <div>
                                                        <a href="" class="">
                                                            <h4 class="item-title no-wrap"> Bimbimkhoai </h4>
                                                        </a>
                                                    </div>
                                                </div>
