                    ...
                    <div class="sidebar-container">
                        <div class="sidebar-header">
                            <a href="index.html" style="text-decoration: none;">
                                ...
                                <span style="padding-left: 10px">  <b>LAKH </b> </span> 
                        ...
                        <nav class="menu">
                            <ul class="sidebar-menu metismenu" id="sidebar-menu">
                                ...
                                <li>
                                    <a href="">
                                        <i class="fa fa-th-large"></i> Quản Lý Người Dùng <i class="fa arrow"></i>
                                    </a>
                                    <ul class="sidebar-nav">
                                        <li>
                                            <a href="teacher-list.html"> Giáo Viên </a>
                                        </li>
                                        <li>
                                            <a href="center-list.html"> Trung Tâm </a>
                                        </li>
                                        <li>
                                            <a href="rescruiment-list.html"> Bài Tuyển Dụng </a>
                                        </li>
                                        <li>
                                            <a href="item-editor.html"> Gửi Thông Báo </a>
                                        </li>
                                    </ul>
                                </li>
