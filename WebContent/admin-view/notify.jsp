            ...
            <div class="app" id="app">
                ...
                <article class="content item-editor-page">
                    <div class="title-block">
                        <h3 class="title"> Send Notify <span class="sparkline bar" data-type="bar"></span>
                        </h3>
                    </div>
                    <form name="item">
                        <div class="card card-block">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-2 form-control-label text-xs-right"> Send to all: </label>
                                <div class="col-sm-10">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-2 form-control-label text-xs-right"> Or </label>
                            </div> 
                            <div class="form-group row">
                                <label class="col-sm-2 form-control-label text-xs-right"> Account </label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control boxed" placeholder="">
                                </div>
                            </div>                            
